...
- Repository URL / local path: https://github.com/JWebMP/WebAwesomePro.git
- Org and project name: JWebMP / Web Awesome Pro
- Short description: The JWebMP For Web Awesome Pro components
